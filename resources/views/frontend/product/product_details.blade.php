        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-1 order-lg-1 order-2" >
                    <ul class="image_list">
                    @isset($images)	
                        <li data-image="{{ asset('files/product/'.$product->thumbnail) }}">
                            <img src="{{ asset('files/product/'.$product->thumbnail) }}" alt="">
                        </li>
                                ...
                                <div class="button_container">
                                    <div class="input-group mb-3">
                                      <div class="input-group-prepend">
                                            ...
                                            @else
                                                <button style="cursor: pointer" class="btn btn-outline-info" type="submit"> <span class="loading d-none">....</span> Add to cart</button>
                                            @endif    
                                            <a href="{{route('product.wishlist',$product->id)}}" class="btn btn-outline-primary" type="button">Add to wishlist</a>
                                      </div>
                                    </div>
                                </div>                                   
                            </form>   
                  ...
                  <div class="card-header">
                    ...
                    <div class="card-body">
                        <div class="row">
                            @if (count($review)==0)
                                <div class="col-md-">
                                    Average Review of  {{ $product->name }}: 0 <br>
                                </div>
                                <div class="col-md-3">
                                    Total Review Of This Product: 0
                                </div>
                            @else
                                <div class="col-lg-3">
                                ...
                                <div class="card col-lg-5 m-2">
                                  ...
                                  <div class="card-body">
                                          {{ $row->review }}
                                            @if($row->rating==5)
                                            <div>
                                                <span class="fa fa-star text-warning text-warning"></span>
                                                <span class="fa fa-star text-warning"></span>
                                                <span class="fa fa-star text-warning"></span>
                                                <span class="fa fa-star text-warning"></span>
                                                <span class="fa fa-star text-warning"></span>
