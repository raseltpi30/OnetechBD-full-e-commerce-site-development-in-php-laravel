                    ...
                    <div class="row">
                        <div class="col d-flex flex-row">
                            ...
                            <div class="top_bar_contact_item">
                                ...
                                <a href="mailto:{{ optional($setting)->main_email }}">
                                    {{ optional($setting)->main_email }}
                                </a>
                            </div>
                                ...
                                @guest
                                    <div class="top_bar_menu">
                                        <ul class="standard_dropdown top_bar_dropdown">
                                                ...
                                                <ul style="width:300px; padding:10px;">
                                                    <div>
                                                        ...
                                                        <form action="{{ route('customer.login') }}" method="post">
                                                            ...
                                                            <div class="form-group">
                                                                <button type="submit"
                                                                    class="btn btn-sm btn-info w-100">login</button>
                                                                <a class="btn btn-link m-0"
                                            ...
                                            <li class="register">
                                                <a href="{{ route('customer.register') }}">Register<i
                                                        class="fas fa-chevron-down"></i></a>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <div class="cart">
                                    <div class="cart_container d-flex flex-row align-items-center justify-content-end">
                                        ...
                                        <div class="cart_content">
                                            ...
                                            <div class="cart_price">{{ optional($setting)->currency }} <span
